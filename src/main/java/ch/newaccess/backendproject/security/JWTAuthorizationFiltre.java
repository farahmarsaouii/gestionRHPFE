...
public class JWTAuthorizationFiltre extends OncePerRequestFilter { 
	...
	//	response.addHeader("Access-Control-Allow-Origin", "GET, POST, OPTIONS, PUT, DELETE"); 
	 ...
	 privileges.forEach(r->{ authorities.add(new SimpleGrantedAuthority(r.get("authority"))); });
